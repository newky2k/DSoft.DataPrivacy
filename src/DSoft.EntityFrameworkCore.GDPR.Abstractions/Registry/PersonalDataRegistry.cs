...
public sealed class PersonalDataRegistry
{
    ...
    /// <summary>Scans the given types and keeps those that carry any GDPR attribute.</summary>
    ...
    /// <summary>The description of <paramref name="type"/>, or <c>null</c> when it carries no GDPR attributes.</summary>
