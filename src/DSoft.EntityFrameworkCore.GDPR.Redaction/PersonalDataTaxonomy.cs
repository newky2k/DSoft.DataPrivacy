...
namespace DSoft.EntityFrameworkCore.GDPR.Redaction;
...
public static class PersonalDataTaxonomy
{
    ...
    public const string TaxonomyName = "GDPR";
...
/// <see cref="GdprRedactionBuilderExtensions.AddPersonalDataRedactors"/> applies to it.
/// </summary>
/// <example>
/// <code>
