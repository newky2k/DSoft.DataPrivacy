...
/// <summary>
/// The Entity Framework model annotations that carry the personal data classification. Values are primitives (bool, int,
/// long, string) so they survive into compiled models and migration snapshots without a type dependency.
/// </summary>
public static class PrivacyAnnotationNames
{
    /// <summary>The prefix shared by every annotation.</summary>
    public const string Prefix = "Privacy:";
