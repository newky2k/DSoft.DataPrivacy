...
/// <summary>
/// Reads the data privacy attributes on a type. This is the one place attributes are interpreted; the registry, the
...
public static class PersonalDataAttributeReader
{
    ...
    public static PersonalDataPropertyClassification? Classify(PropertyInfo property)
    {
        ...
        if (attribute != null)
        {
            return new PersonalDataPropertyClassification
            {
                ...
                RetentionGround = attribute.RetentionGround,
    ...
    private static PersonalDataTypeInfo Read(Type type)
    {
        ...
        return new PersonalDataTypeInfo(
            ...
            erasure: erasure,
            ground: retain?.RetentionGround ?? RetentionGround.None,
            retentionReason: retain?.Reason,
